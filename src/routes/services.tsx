...
const services = [
  ...
  { icon: ShieldCheck, price: "₹2,499", priceId: "emergency_visit_single", title: "Emergency Visit", desc: "Rapid on-ground support when something feels off — a verified person at the door within hours.", includes: ["Priority dispatch", "Live updates to family", "Coordination with neighbours", "Follow-up visit included"] },
  { icon: Sparkles, price: "from ₹3,499 / mo", priceId: "care_plan_4_monthly", title: "Care Plan — Monthly", desc: "Recurring monthly visits — 4, 8 or 12 per month — with the same companion where possible and priority emergency support.", includes: ["Recurring schedule", "Same companion where possible", "Monthly summary report", "Priority emergency support"] },
];
